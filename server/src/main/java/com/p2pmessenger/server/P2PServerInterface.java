...
public interface P2PServerInterface extends Remote{
    ...
    /*2 alternativas ao aceptar, ou actualizamos directamente dende o cliente a súa lista de 
    amigos e logo actualizala no server, ou actualizala no server e que o server se encargue de
    actualizala no cliente*/
